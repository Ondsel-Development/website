...
The basics of an integrated assembly workbench in FreeCAD are now functional and will be ready for for wider testing once [another pull request](https://github.com/FreeCAD/FreeCAD/pull/10764) is merged. This means you can play with it now in the development version of FreeCAD and when version 1.0 is out, you will be able to create or link parts, create joints between them, and solve the assembly — in just a few clicks, out of the box, without installing any add-ons.
