...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">FreeCAD assembly driving real world assembly. Still needs some polish (also literally: joints are too tight for fluid movement) the code and models will be published.<br>The FreeCAD assembly is dragged real-time with a mouse. <a href="https://t.co/UeGP5PVjcr">pic.twitter.com/UeGP5PVjcr</a></p>&mdash; 𝕂𝕨𝕒𝕙𝕠𝕠 (@kwahoo_archive) <a href="https://twitter.com/kwahoo_archive/status/1747014082585063811?ref_src=twsrc%5Etfw">January 15, 2024</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
