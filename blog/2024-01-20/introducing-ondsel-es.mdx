...
As for **overall UX/UI improvements**, the default user interface theme used by Ondsel ES is [OpenDark](https://github.com/obelisk79/OpenTheme/), a project by Joe Sardos aka "Obelisk". This seems to be a popular customnization choice among users, so we went with it.
