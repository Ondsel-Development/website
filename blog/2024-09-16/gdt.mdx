...
3. Change balloon’s settings to use a rectangular frame.
4. Use a different tool to construct balloon's label from presets.
5. Copy/paste that label into balloon's text box.
