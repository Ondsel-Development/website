...
![](link-to-raw-file-on-github.webp)
...
1. **Make the reloadable work directly with files shared on our web service.** Imagine being able to browse for a needed off-the-shelf part through the Ondsel addon, click on it, and have it immediately available inside your document as a reloadable. If the upstream file changes, you would be able to update your copy with a click.
